...
'zh':
	{
		...
		'help':
		{
			...
			'face_detector_margin': '对帧应用上、右、下、左的外边距',
			...
			'job_list': '按状态列出任务',
			'job_create': '创建草稿任务',
			'job_submit': '提交草稿任务使其成为排队任务',
			'job_submit_all': '提交所有草稿任务使其成为排队任务',
			'job_delete': '删除草稿、排队、失败或已完成的任务',
			'job_delete_all': '删除所有草稿、排队、失败和已完成的任务',
			'job_add_step': '向草稿任务添加一个步骤',
			'job_remix_step': '从草稿任务中重新混合之前的步骤',
			'job_insert_step': '向草稿任务插入一个步骤',
			'job_remove_step': '从草稿任务中移除一个步骤',
			'job_run': '运行排队任务',
		...
		'uis':
		{
			...
			'face_detector_margin_slider': '人脸检测外边距',
